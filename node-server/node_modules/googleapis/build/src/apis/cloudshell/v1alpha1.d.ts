...
export declare namespace cloudshell_v1alpha1 {
    ...
    class Resource$Users$Environments {
         ...
         */
        authorize(params?: Params$Resource$Users$Environments$Authorize, options?: MethodOptions): AxiosPromise<Schema$Empty>;
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Users$Environments$Get, options?: MethodOptions): AxiosPromise<Schema$Environment>;
         ...
         * @return {object} Request object
         */
        patch(params?: Params$Resource$Users$Environments$Patch, options?: MethodOptions): AxiosPromise<Schema$Environment>;
         ...
         * @return {object} Request object
         */
        start(params?: Params$Resource$Users$Environments$Start, options?: MethodOptions): AxiosPromise<Schema$Operation>;
    ...
    interface Params$Resource$Users$Environments$Authorize {
        /**
    ...
    interface Params$Resource$Users$Environments$Get {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Users$Environments$Patch {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Users$Environments$Start {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Users$Environments$Publickeys {
         ...
         * @return {object} Request object
         */
        create(params?: Params$Resource$Users$Environments$Publickeys$Create, options?: MethodOptions): AxiosPromise<Schema$PublicKey>;
         ...
         * @return {object} Request object
         */
        delete(params?: Params$Resource$Users$Environments$Publickeys$Delete, options?: MethodOptions): AxiosPromise<Schema$Empty>;
    ...
    interface Params$Resource$Users$Environments$Publickeys$Create {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Users$Environments$Publickeys$Delete {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

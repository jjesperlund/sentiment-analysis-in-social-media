...
export declare namespace composer_v1beta1 {
    ...
    class Resource$Projects$Locations$Environments {
         ...
         */
        create(params?: Params$Resource$Projects$Locations$Environments$Create, options?: MethodOptions): AxiosPromise<Schema$Operation>;
         ...
         * @return {object} Request object
         */
        delete(params?: Params$Resource$Projects$Locations$Environments$Delete, options?: MethodOptions): AxiosPromise<Schema$Operation>;
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Projects$Locations$Environments$Get, options?: MethodOptions): AxiosPromise<Schema$Environment>;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Projects$Locations$Environments$List, options?: MethodOptions): AxiosPromise<Schema$ListEnvironmentsResponse>;
         ...
         * @return {object} Request object
         */
        patch(params?: Params$Resource$Projects$Locations$Environments$Patch, options?: MethodOptions): AxiosPromise<Schema$Operation>;
    ...
    interface Params$Resource$Projects$Locations$Environments$Create {
        /**
    ...
    interface Params$Resource$Projects$Locations$Environments$Delete {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Locations$Environments$Get {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Locations$Environments$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Locations$Environments$Patch {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

...
export declare namespace appstate_v1 {
    ...
    class Resource$States {
         ...
         */
        clear(params?: Params$Resource$States$Clear, options?: MethodOptions): AxiosPromise<Schema$WriteResult>;
         ...
         * @return {object} Request object
         */
        delete(params?: Params$Resource$States$Delete, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$States$Get, options?: MethodOptions): AxiosPromise<Schema$GetResponse>;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$States$List, options?: MethodOptions): AxiosPromise<Schema$ListResponse>;
         ...
         * @return {object} Request object
         */
        update(params?: Params$Resource$States$Update, options?: MethodOptions): AxiosPromise<Schema$WriteResult>;
    ...
    interface Params$Resource$States$Clear {
        /**
    ...
    interface Params$Resource$States$Delete {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$States$Get {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$States$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$States$Update {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

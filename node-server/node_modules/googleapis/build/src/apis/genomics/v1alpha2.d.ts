...
export declare namespace genomics_v1alpha2 {
    ...
    class Resource$Pipelines {
         ...
         * @return {object} Request object
         */
        create(params?: Params$Resource$Pipelines$Create, options?: MethodOptions): AxiosPromise<Schema$Pipeline>;
         ...
         * @return {object} Request object
         */
        delete(params?: Params$Resource$Pipelines$Delete, options?: MethodOptions): AxiosPromise<Schema$Empty>;
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Pipelines$Get, options?: MethodOptions): AxiosPromise<Schema$Pipeline>;
         ...
         * @return {object} Request object
         */
        getControllerConfig(params?: Params$Resource$Pipelines$Getcontrollerconfig, options?: MethodOptions): AxiosPromise<Schema$ControllerConfig>;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Pipelines$List, options?: MethodOptions): AxiosPromise<Schema$ListPipelinesResponse>;
         ...
         * @return {object} Request object
         */
        setOperationStatus(params?: Params$Resource$Pipelines$Setoperationstatus, options?: MethodOptions): AxiosPromise<Schema$Empty>;
    ...
    interface Params$Resource$Pipelines$Create {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Pipelines$Delete {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Pipelines$Get {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Pipelines$Getcontrollerconfig {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Pipelines$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Pipelines$Setoperationstatus {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

...
export declare namespace clouderrorreporting_v1beta1 {
    ...
    class Resource$Projects {
         ...
         */
        deleteEvents(params?: Params$Resource$Projects$Deleteevents, options?: MethodOptions): AxiosPromise<Schema$DeleteEventsResponse>;
    ...
    interface Params$Resource$Projects$Deleteevents {
        /**
    ...
    class Resource$Projects$Events {
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Projects$Events$List, options?: MethodOptions): AxiosPromise<Schema$ListEventsResponse>;
         ...
         * @return {object} Request object
         */
        report(params?: Params$Resource$Projects$Events$Report, options?: MethodOptions): AxiosPromise<Schema$ReportErrorEventResponse>;
    ...
    interface Params$Resource$Projects$Events$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Events$Report {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Projects$Groups {
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Projects$Groups$Get, options?: MethodOptions): AxiosPromise<Schema$ErrorGroup>;
         ...
         * @return {object} Request object
         */
        update(params?: Params$Resource$Projects$Groups$Update, options?: MethodOptions): AxiosPromise<Schema$ErrorGroup>;
    ...
    class Resource$Projects$Groupstats {
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Projects$Groupstats$List, options?: MethodOptions): AxiosPromise<Schema$ListGroupStatsResponse>;
    ...
    interface Params$Resource$Projects$Groupstats$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

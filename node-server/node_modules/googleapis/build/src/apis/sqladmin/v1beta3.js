...
var sqladmin_v1beta3;
(function (sqladmin_v1beta3) {
    /**
     * Cloud SQL Admin API
     *
    ...
    sqladmin_v1beta3.Sqladmin = Sqladmin;
    ...
    sqladmin_v1beta3.Resource$Backupruns = Resource$Backupruns;
    ...
    sqladmin_v1beta3.Resource$Flags = Resource$Flags;
    class Resource$Instances {
        ...
        import(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const rootUrl = options.rootUrl || 'https://www.googleapis.com/';
            const parameters = { options: Object.assign({ url: (rootUrl + '/sql/v1beta3/projects/{project}/instances/{instance}/import').replace(/([^:]\/)\/+/g, '$1'), method: 'POST' }, options), params, requiredParams: ['project', 'instance'], pathParams: ['instance', 'project'], context: this.getRoot() };
            if (callback) {
                googleapis_common_1.createAPIRequest(parameters, callback);
            }
            else {
        ...
        setRootPassword(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback || {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
                callback = paramsOrCallback;
    ...
    sqladmin_v1beta3.Resource$Instances = Resource$Instances;
    ...
    sqladmin_v1beta3.Resource$Operations = Resource$Operations;
    ...
    sqladmin_v1beta3.Resource$Sslcerts = Resource$Sslcerts;
    ...
    sqladmin_v1beta3.Resource$Tiers = Resource$Tiers;
})(sqladmin_v1beta3 = exports.sqladmin_v1beta3 || (exports.sqladmin_v1beta3 = {}));

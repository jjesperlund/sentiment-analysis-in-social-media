...
export declare namespace webmasters_v3 {
    ...
    class Resource$Searchanalytics {
         ...
         */
        query(params?: Params$Resource$Searchanalytics$Query, options?: MethodOptions): AxiosPromise<Schema$SearchAnalyticsQueryResponse>;
    ...
    interface Params$Resource$Searchanalytics$Query {
        /**
    ...
    class Resource$Sitemaps {
         ...
         * @return {object} Request object
         */
        delete(params?: Params$Resource$Sitemaps$Delete, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Sitemaps$Get, options?: MethodOptions): AxiosPromise<Schema$WmxSitemap>;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Sitemaps$List, options?: MethodOptions): AxiosPromise<Schema$SitemapsListResponse>;
         ...
         * @return {object} Request object
         */
        submit(params?: Params$Resource$Sitemaps$Submit, options?: MethodOptions): AxiosPromise<void>;
    ...
    interface Params$Resource$Sitemaps$Delete {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Sitemaps$Get {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Sitemaps$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Sitemaps$Submit {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Sites {
         ...
         * @return {object} Request object
         */
        add(params?: Params$Resource$Sites$Add, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        delete(params?: Params$Resource$Sites$Delete, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Sites$Get, options?: MethodOptions): AxiosPromise<Schema$WmxSite>;
    ...
    interface Params$Resource$Sites$Add {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Sites$Delete {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Urlcrawlerrorscounts {
         ...
         * @return {object} Request object
         */
        query(params?: Params$Resource$Urlcrawlerrorscounts$Query, options?: MethodOptions): AxiosPromise<Schema$UrlCrawlErrorsCountsQueryResponse>;
    ...
    interface Params$Resource$Urlcrawlerrorscounts$Query {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Urlcrawlerrorssamples {
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Urlcrawlerrorssamples$Get, options?: MethodOptions): AxiosPromise<Schema$UrlCrawlErrorsSample>;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Urlcrawlerrorssamples$List, options?: MethodOptions): AxiosPromise<Schema$UrlCrawlErrorsSamplesListResponse>;
         ...
         * @return {object} Request object
         */
        markAsFixed(params?: Params$Resource$Urlcrawlerrorssamples$Markasfixed, options?: MethodOptions): AxiosPromise<void>;
    ...
    interface Params$Resource$Urlcrawlerrorssamples$Get {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Urlcrawlerrorssamples$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Urlcrawlerrorssamples$Markasfixed {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

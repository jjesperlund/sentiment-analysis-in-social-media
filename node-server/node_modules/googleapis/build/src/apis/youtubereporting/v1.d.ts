...
export declare namespace youtubereporting_v1 {
    ...
    class Resource$Jobs$Reports {
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Jobs$Reports$Get, options?: MethodOptions): AxiosPromise<Schema$Report>;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Jobs$Reports$List, options?: MethodOptions): AxiosPromise<Schema$ListReportsResponse>;
    ...
    interface Params$Resource$Jobs$Reports$Get {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Jobs$Reports$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Media {
         ...
         * @return {object} Request object
         */
        download(params?: Params$Resource$Media$Download, options?: MethodOptions): AxiosPromise<Schema$GdataMedia>;
    ...
    class Resource$Reporttypes {
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Reporttypes$List, options?: MethodOptions): AxiosPromise<Schema$ListReportTypesResponse>;
    ...
    interface Params$Resource$Reporttypes$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

...
export declare namespace poly_v1 {
    ...
    class Resource$Assets {
         ...
         */
        get(params?: Params$Resource$Assets$Get, options?: MethodOptions): AxiosPromise<Schema$Asset>;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Assets$List, options?: MethodOptions): AxiosPromise<Schema$ListAssetsResponse>;
    ...
    interface Params$Resource$Assets$Get {
        /**
    ...
    interface Params$Resource$Assets$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Users$Assets {
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Users$Assets$List, options?: MethodOptions): AxiosPromise<Schema$ListUserAssetsResponse>;
    ...
    class Resource$Users$Likedassets {
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Users$Likedassets$List, options?: MethodOptions): AxiosPromise<Schema$ListLikedAssetsResponse>;
    ...
    interface Params$Resource$Users$Likedassets$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

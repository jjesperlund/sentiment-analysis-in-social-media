...
export declare namespace speech_v1beta1 {
     ...
     */
    interface Schema$AsyncRecognizeRequest {
        /**
     ...
     */
    interface Schema$SyncRecognizeRequest {
        /**
         * *Required* The audio data to be recognized.
         */
        audio?: Schema$RecognitionAudio;
     ...
     * messages.
     */
    interface Schema$SyncRecognizeResponse {
        /**
    ...
    class Resource$Speech {
         ...
         * @return {object} Request object
         */
        asyncrecognize(params?: Params$Resource$Speech$Asyncrecognize, options?: MethodOptions): AxiosPromise<Schema$Operation>;
        asyncrecognize(params: Params$Resource$Speech$Asyncrecognize, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        asyncrecognize(params: Params$Resource$Speech$Asyncrecognize, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @return {object} Request object
         */
        syncrecognize(params?: Params$Resource$Speech$Syncrecognize, options?: MethodOptions): AxiosPromise<Schema$SyncRecognizeResponse>;
        syncrecognize(params: Params$Resource$Speech$Syncrecognize, options: MethodOptions | BodyResponseCallback<Schema$SyncRecognizeResponse>, callback: BodyResponseCallback<Schema$SyncRecognizeResponse>): void;
        syncrecognize(params: Params$Resource$Speech$Syncrecognize, callback: BodyResponseCallback<Schema$SyncRecognizeResponse>): void;
        syncrecognize(callback: BodyResponseCallback<Schema$SyncRecognizeResponse>): void;
    }
    interface Params$Resource$Speech$Asyncrecognize {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Speech$Syncrecognize {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

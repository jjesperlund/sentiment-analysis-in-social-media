...
export declare namespace customsearch_v1 {
    ...
    class Resource$Cse {
         ...
         */
        list(params?: Params$Resource$Cse$List, options?: MethodOptions): AxiosPromise<Schema$Search>;
    ...
    interface Params$Resource$Cse$List {
        /**
    ...
    class Resource$Cse$Siterestrict {
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Cse$Siterestrict$List, options?: MethodOptions): AxiosPromise<Schema$Search>;
    ...
    interface Params$Resource$Cse$Siterestrict$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

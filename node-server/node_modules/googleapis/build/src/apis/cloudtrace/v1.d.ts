...
export declare namespace cloudtrace_v1 {
    ...
    class Resource$Projects {
         ...
         */
        patchTraces(params?: Params$Resource$Projects$Patchtraces, options?: MethodOptions): AxiosPromise<Schema$Empty>;
    ...
    interface Params$Resource$Projects$Patchtraces {
        /**
    ...
    class Resource$Projects$Traces {
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Projects$Traces$Get, options?: MethodOptions): AxiosPromise<Schema$Trace>;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Projects$Traces$List, options?: MethodOptions): AxiosPromise<Schema$ListTracesResponse>;
    ...
    interface Params$Resource$Projects$Traces$Get {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Traces$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

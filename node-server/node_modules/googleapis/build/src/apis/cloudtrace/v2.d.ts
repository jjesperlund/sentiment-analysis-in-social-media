...
export declare namespace cloudtrace_v2 {
    ...
    class Resource$Projects$Traces {
         ...
         */
        batchWrite(params?: Params$Resource$Projects$Traces$Batchwrite, options?: MethodOptions): AxiosPromise<Schema$Empty>;
    ...
    interface Params$Resource$Projects$Traces$Batchwrite {
        /**
    ...
    class Resource$Projects$Traces$Spans {
         ...
         * @return {object} Request object
         */
        createSpan(params?: Params$Resource$Projects$Traces$Spans$Createspan, options?: MethodOptions): AxiosPromise<Schema$Span>;
    ...
    interface Params$Resource$Projects$Traces$Spans$Createspan {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

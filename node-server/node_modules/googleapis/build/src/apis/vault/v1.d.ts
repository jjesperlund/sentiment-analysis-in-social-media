...
export declare namespace vault_v1 {
    ...
    class Resource$Matters$Exports {
         ...
         * @return {object} Request object
         */
        create(params?: Params$Resource$Matters$Exports$Create, options?: MethodOptions): AxiosPromise<Schema$Export>;
         ...
         * @return {object} Request object
         */
        delete(params?: Params$Resource$Matters$Exports$Delete, options?: MethodOptions): AxiosPromise<Schema$Empty>;
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Matters$Exports$Get, options?: MethodOptions): AxiosPromise<Schema$Export>;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Matters$Exports$List, options?: MethodOptions): AxiosPromise<Schema$ListExportsResponse>;
    ...
    interface Params$Resource$Matters$Exports$Create {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Matters$Exports$Delete {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Matters$Exports$Get {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Matters$Exports$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Matters$Holds {
         ...
         * @return {object} Request object
         */
        addHeldAccounts(params?: Params$Resource$Matters$Holds$Addheldaccounts, options?: MethodOptions): AxiosPromise<Schema$AddHeldAccountsResponse>;
         ...
         * @return {object} Request object
         */
        removeHeldAccounts(params?: Params$Resource$Matters$Holds$Removeheldaccounts, options?: MethodOptions): AxiosPromise<Schema$RemoveHeldAccountsResponse>;
    ...
    interface Params$Resource$Matters$Holds$Addheldaccounts {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Matters$Holds$Removeheldaccounts {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

...
export declare namespace digitalassetlinks_v1 {
    ...
    class Resource$Assetlinks {
         ...
         */
        check(params?: Params$Resource$Assetlinks$Check, options?: MethodOptions): AxiosPromise<Schema$CheckResponse>;
    ...
    interface Params$Resource$Assetlinks$Check {
        /**
    ...
    class Resource$Statements {
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Statements$List, options?: MethodOptions): AxiosPromise<Schema$ListResponse>;
    ...
    interface Params$Resource$Statements$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

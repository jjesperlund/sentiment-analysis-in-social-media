...
export declare namespace youtubeAnalytics_v1beta1 {
    ...
    class Resource$Groupitems {
         ...
         */
        delete(params?: Params$Resource$Groupitems$Delete, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        insert(params?: Params$Resource$Groupitems$Insert, options?: MethodOptions): AxiosPromise<Schema$GroupItem>;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Groupitems$List, options?: MethodOptions): AxiosPromise<Schema$GroupItemListResponse>;
    ...
    interface Params$Resource$Groupitems$Delete {
        /**
    ...
    interface Params$Resource$Groupitems$Insert {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Groupitems$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Groups {
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Groups$List, options?: MethodOptions): AxiosPromise<Schema$GroupListResponse>;
    ...
    class Resource$Reports {
         ...
         * @return {object} Request object
         */
        query(params?: Params$Resource$Reports$Query, options?: MethodOptions): AxiosPromise<Schema$ResultTable>;
    ...
    interface Params$Resource$Reports$Query {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

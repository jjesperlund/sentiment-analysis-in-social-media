...
export declare namespace manufacturers_v1 {
    ...
    class Resource$Accounts$Products {
         ...
         */
        delete(params?: Params$Resource$Accounts$Products$Delete, options?: MethodOptions): AxiosPromise<Schema$Empty>;
         ...
         * @return {object} Request object
         */
        update(params?: Params$Resource$Accounts$Products$Update, options?: MethodOptions): AxiosPromise<Schema$Empty>;
    ...
    interface Params$Resource$Accounts$Products$Delete {
        /**
    ...
    interface Params$Resource$Accounts$Products$Get {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Accounts$Products$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Accounts$Products$Update {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

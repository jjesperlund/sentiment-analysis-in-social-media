...
export declare namespace replicapool_v1beta1 {
    ...
    class Resource$Pools {
         ...
         */
        delete(params?: Params$Resource$Pools$Delete, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Pools$Get, options?: MethodOptions): AxiosPromise<Schema$Pool>;
         ...
         * @return {object} Request object
         */
        insert(params?: Params$Resource$Pools$Insert, options?: MethodOptions): AxiosPromise<Schema$Pool>;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Pools$List, options?: MethodOptions): AxiosPromise<Schema$PoolsListResponse>;
         ...
         * @return {object} Request object
         */
        resize(params?: Params$Resource$Pools$Resize, options?: MethodOptions): AxiosPromise<Schema$Pool>;
         ...
         * @return {object} Request object
         */
        updatetemplate(params?: Params$Resource$Pools$Updatetemplate, options?: MethodOptions): AxiosPromise<void>;
    ...
    interface Params$Resource$Pools$Delete {
        /**
    ...
    interface Params$Resource$Pools$Get {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Pools$Insert {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Pools$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Pools$Resize {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Pools$Updatetemplate {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Replicas {
         ...
         * @return {object} Request object
         */
        delete(params?: Params$Resource$Replicas$Delete, options?: MethodOptions): AxiosPromise<Schema$Replica>;
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Replicas$Get, options?: MethodOptions): AxiosPromise<Schema$Replica>;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Replicas$List, options?: MethodOptions): AxiosPromise<Schema$ReplicasListResponse>;
         ...
         * @return {object} Request object
         */
        restart(params?: Params$Resource$Replicas$Restart, options?: MethodOptions): AxiosPromise<Schema$Replica>;
    ...
    interface Params$Resource$Replicas$Delete {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Replicas$Get {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Replicas$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Replicas$Restart {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

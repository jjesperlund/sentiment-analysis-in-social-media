...
export declare namespace gamesManagement_v1management {
    ...
    class Resource$Achievements {
         ...
         */
        reset(params?: Params$Resource$Achievements$Reset, options?: MethodOptions): AxiosPromise<Schema$AchievementResetResponse>;
         ...
         * @return {object} Request object
         */
        resetAll(params?: Params$Resource$Achievements$Resetall, options?: MethodOptions): AxiosPromise<Schema$AchievementResetAllResponse>;
         ...
         * @return {object} Request object
         */
        resetAllForAllPlayers(params?: Params$Resource$Achievements$Resetallforallplayers, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        resetForAllPlayers(params?: Params$Resource$Achievements$Resetforallplayers, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        resetMultipleForAllPlayers(params?: Params$Resource$Achievements$Resetmultipleforallplayers, options?: MethodOptions): AxiosPromise<void>;
    ...
    interface Params$Resource$Achievements$Reset {
        /**
    ...
    interface Params$Resource$Achievements$Resetall {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    }
    interface Params$Resource$Achievements$Resetallforallplayers {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    }
    interface Params$Resource$Achievements$Resetforallplayers {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Achievements$Resetmultipleforallplayers {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Applications {
         ...
         * @return {object} Request object
         */
        listHidden(params?: Params$Resource$Applications$Listhidden, options?: MethodOptions): AxiosPromise<Schema$HiddenPlayerList>;
    ...
    interface Params$Resource$Applications$Listhidden {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Events {
         ...
         * @return {object} Request object
         */
        reset(params?: Params$Resource$Events$Reset, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        resetAll(params?: Params$Resource$Events$Resetall, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        resetAllForAllPlayers(params?: Params$Resource$Events$Resetallforallplayers, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        resetForAllPlayers(params?: Params$Resource$Events$Resetforallplayers, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        resetMultipleForAllPlayers(params?: Params$Resource$Events$Resetmultipleforallplayers, options?: MethodOptions): AxiosPromise<void>;
    ...
    interface Params$Resource$Events$Reset {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Events$Resetall {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    }
    interface Params$Resource$Events$Resetallforallplayers {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    }
    interface Params$Resource$Events$Resetforallplayers {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Events$Resetmultipleforallplayers {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Players {
         ...
         * @return {object} Request object
         */
        hide(params?: Params$Resource$Players$Hide, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        unhide(params?: Params$Resource$Players$Unhide, options?: MethodOptions): AxiosPromise<void>;
    ...
    interface Params$Resource$Players$Hide {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Players$Unhide {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Quests {
         ...
         * @return {object} Request object
         */
        reset(params?: Params$Resource$Quests$Reset, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        resetAll(params?: Params$Resource$Quests$Resetall, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        resetAllForAllPlayers(params?: Params$Resource$Quests$Resetallforallplayers, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        resetForAllPlayers(params?: Params$Resource$Quests$Resetforallplayers, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        resetMultipleForAllPlayers(params?: Params$Resource$Quests$Resetmultipleforallplayers, options?: MethodOptions): AxiosPromise<void>;
    ...
    interface Params$Resource$Quests$Reset {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Quests$Resetall {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    }
    interface Params$Resource$Quests$Resetallforallplayers {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    }
    interface Params$Resource$Quests$Resetforallplayers {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Quests$Resetmultipleforallplayers {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Rooms {
         ...
         * @return {object} Request object
         */
        reset(params?: Params$Resource$Rooms$Reset, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        resetForAllPlayers(params?: Params$Resource$Rooms$Resetforallplayers, options?: MethodOptions): AxiosPromise<void>;
    ...
    interface Params$Resource$Rooms$Reset {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    }
    interface Params$Resource$Rooms$Resetforallplayers {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Scores {
         ...
         * @return {object} Request object
         */
        reset(params?: Params$Resource$Scores$Reset, options?: MethodOptions): AxiosPromise<Schema$PlayerScoreResetResponse>;
         ...
         * @return {object} Request object
         */
        resetAll(params?: Params$Resource$Scores$Resetall, options?: MethodOptions): AxiosPromise<Schema$PlayerScoreResetAllResponse>;
         ...
         * @return {object} Request object
         */
        resetAllForAllPlayers(params?: Params$Resource$Scores$Resetallforallplayers, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        resetForAllPlayers(params?: Params$Resource$Scores$Resetforallplayers, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        resetMultipleForAllPlayers(params?: Params$Resource$Scores$Resetmultipleforallplayers, options?: MethodOptions): AxiosPromise<void>;
    ...
    interface Params$Resource$Scores$Reset {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Scores$Resetall {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    }
    interface Params$Resource$Scores$Resetallforallplayers {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    }
    interface Params$Resource$Scores$Resetforallplayers {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Scores$Resetmultipleforallplayers {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Turnbasedmatches {
         ...
         * @return {object} Request object
         */
        reset(params?: Params$Resource$Turnbasedmatches$Reset, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        resetForAllPlayers(params?: Params$Resource$Turnbasedmatches$Resetforallplayers, options?: MethodOptions): AxiosPromise<void>;
    ...
    interface Params$Resource$Turnbasedmatches$Reset {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    }
    interface Params$Resource$Turnbasedmatches$Resetforallplayers {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

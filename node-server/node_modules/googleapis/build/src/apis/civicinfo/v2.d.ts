...
export declare namespace civicinfo_v2 {
    ...
    class Resource$Divisions {
         ...
         */
        search(params?: Params$Resource$Divisions$Search, options?: MethodOptions): AxiosPromise<Schema$DivisionSearchResponse>;
    ...
    interface Params$Resource$Divisions$Search {
        /**
    ...
    class Resource$Elections {
         ...
         * @return {object} Request object
         */
        electionQuery(params?: Params$Resource$Elections$Electionquery, options?: MethodOptions): AxiosPromise<Schema$ElectionsQueryResponse>;
         ...
         * @return {object} Request object
         */
        voterInfoQuery(params?: Params$Resource$Elections$Voterinfoquery, options?: MethodOptions): AxiosPromise<Schema$VoterInfoResponse>;
    ...
    interface Params$Resource$Elections$Electionquery {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Elections$Voterinfoquery {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Representatives {
         ...
         * @return {object} Request object
         */
        representativeInfoByAddress(params?: Params$Resource$Representatives$Representativeinfobyaddress, options?: MethodOptions): AxiosPromise<Schema$RepresentativeInfoResponse>;
         ...
         * @return {object} Request object
         */
        representativeInfoByDivision(params?: Params$Resource$Representatives$Representativeinfobydivision, options?: MethodOptions): AxiosPromise<Schema$RepresentativeInfoData>;
    ...
    interface Params$Resource$Representatives$Representativeinfobyaddress {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Representatives$Representativeinfobydivision {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

...
export declare namespace licensing_v1 {
    ...
    class Resource$Licenseassignments {
         ...
         */
        delete(params?: Params$Resource$Licenseassignments$Delete, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Licenseassignments$Get, options?: MethodOptions): AxiosPromise<Schema$LicenseAssignment>;
         ...
         * @return {object} Request object
         */
        insert(params?: Params$Resource$Licenseassignments$Insert, options?: MethodOptions): AxiosPromise<Schema$LicenseAssignment>;
         ...
         * @return {object} Request object
         */
        listForProduct(params?: Params$Resource$Licenseassignments$Listforproduct, options?: MethodOptions): AxiosPromise<Schema$LicenseAssignmentList>;
         ...
         * @return {object} Request object
         */
        listForProductAndSku(params?: Params$Resource$Licenseassignments$Listforproductandsku, options?: MethodOptions): AxiosPromise<Schema$LicenseAssignmentList>;
         ...
         * @return {object} Request object
         */
        patch(params?: Params$Resource$Licenseassignments$Patch, options?: MethodOptions): AxiosPromise<Schema$LicenseAssignment>;
         ...
         * @return {object} Request object
         */
        update(params?: Params$Resource$Licenseassignments$Update, options?: MethodOptions): AxiosPromise<Schema$LicenseAssignment>;
    ...
    interface Params$Resource$Licenseassignments$Delete {
        /**
    ...
    interface Params$Resource$Licenseassignments$Get {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Licenseassignments$Insert {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Licenseassignments$Listforproduct {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Licenseassignments$Listforproductandsku {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Licenseassignments$Patch {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Licenseassignments$Update {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

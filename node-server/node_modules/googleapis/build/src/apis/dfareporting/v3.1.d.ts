...
export declare namespace dfareporting_v3_1 {
    ...
    class Resource$Mobileapps {
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Mobileapps$Get, options?: MethodOptions): AxiosPromise<Schema$MobileApp>;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Mobileapps$List, options?: MethodOptions): AxiosPromise<Schema$MobileAppsListResponse>;
    ...
    interface Params$Resource$Mobileapps$Get {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Mobileapps$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

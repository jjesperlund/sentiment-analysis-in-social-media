...
export declare namespace doubleclickbidmanager_v1 {
    ...
    class Resource$Lineitems {
         ...
         */
        downloadlineitems(params?: Params$Resource$Lineitems$Downloadlineitems, options?: MethodOptions): AxiosPromise<Schema$DownloadLineItemsResponse>;
         ...
         * @return {object} Request object
         */
        uploadlineitems(params?: Params$Resource$Lineitems$Uploadlineitems, options?: MethodOptions): AxiosPromise<Schema$UploadLineItemsResponse>;
    ...
    interface Params$Resource$Lineitems$Downloadlineitems {
        /**
    ...
    interface Params$Resource$Lineitems$Uploadlineitems {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Queries {
         ...
         * @return {object} Request object
         */
        createquery(params?: Params$Resource$Queries$Createquery, options?: MethodOptions): AxiosPromise<Schema$Query>;
         ...
         * @return {object} Request object
         */
        deletequery(params?: Params$Resource$Queries$Deletequery, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        getquery(params?: Params$Resource$Queries$Getquery, options?: MethodOptions): AxiosPromise<Schema$Query>;
         ...
         * @return {object} Request object
         */
        listqueries(params?: Params$Resource$Queries$Listqueries, options?: MethodOptions): AxiosPromise<Schema$ListQueriesResponse>;
         ...
         * @return {object} Request object
         */
        runquery(params?: Params$Resource$Queries$Runquery, options?: MethodOptions): AxiosPromise<void>;
    ...
    interface Params$Resource$Queries$Createquery {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Queries$Deletequery {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Queries$Getquery {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Queries$Listqueries {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    }
    interface Params$Resource$Queries$Runquery {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Reports {
         ...
         * @return {object} Request object
         */
        listreports(params?: Params$Resource$Reports$Listreports, options?: MethodOptions): AxiosPromise<Schema$ListReportsResponse>;
    ...
    interface Params$Resource$Reports$Listreports {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Sdf {
         ...
         * @return {object} Request object
         */
        download(params?: Params$Resource$Sdf$Download, options?: MethodOptions): AxiosPromise<Schema$DownloadResponse>;
    ...
    interface Params$Resource$Sdf$Download {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

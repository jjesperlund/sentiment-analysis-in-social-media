...
export declare namespace doubleclicksearch_v2 {
    ...
    class Resource$Conversion {
         ...
         */
        get(params?: Params$Resource$Conversion$Get, options?: MethodOptions): AxiosPromise<Schema$ConversionList>;
         ...
         * @return {object} Request object
         */
        insert(params?: Params$Resource$Conversion$Insert, options?: MethodOptions): AxiosPromise<Schema$ConversionList>;
         ...
         * @return {object} Request object
         */
        patch(params?: Params$Resource$Conversion$Patch, options?: MethodOptions): AxiosPromise<Schema$ConversionList>;
         ...
         * @return {object} Request object
         */
        update(params?: Params$Resource$Conversion$Update, options?: MethodOptions): AxiosPromise<Schema$ConversionList>;
         ...
         * @return {object} Request object
         */
        updateAvailability(params?: Params$Resource$Conversion$Updateavailability, options?: MethodOptions): AxiosPromise<Schema$UpdateAvailabilityResponse>;
    ...
    interface Params$Resource$Conversion$Get {
        /**
    ...
    interface Params$Resource$Conversion$Insert {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Conversion$Patch {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Conversion$Update {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Conversion$Updateavailability {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Reports {
         ...
         * @return {object} Request object
         */
        getFile(params?: Params$Resource$Reports$Getfile, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        request(params?: Params$Resource$Reports$Request, options?: MethodOptions): AxiosPromise<Schema$Report>;
    ...
    interface Params$Resource$Reports$Getfile {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Reports$Request {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Savedcolumns {
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Savedcolumns$List, options?: MethodOptions): AxiosPromise<Schema$SavedColumnList>;
    ...
    interface Params$Resource$Savedcolumns$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

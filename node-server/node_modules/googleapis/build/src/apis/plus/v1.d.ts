...
export declare namespace plus_v1 {
    ...
    class Resource$Activities {
         ...
         * @return {object} Request object
         */
        search(params?: Params$Resource$Activities$Search, options?: MethodOptions): AxiosPromise<Schema$ActivityFeed>;
    ...
    interface Params$Resource$Activities$Search {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$People {
         ...
         * @return {object} Request object
         */
        search(params?: Params$Resource$People$Search, options?: MethodOptions): AxiosPromise<Schema$PeopleFeed>;
    ...
    interface Params$Resource$People$Search {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

...
export declare namespace fusiontables_v2 {
    ...
    class Resource$Table {
         ...
         * @return {object} Request object
         */
        refetchSheet(params?: Params$Resource$Table$Refetchsheet, options?: MethodOptions): AxiosPromise<Schema$Task>;
         ...
         * @return {object} Request object
         */
        replaceRows(params?: Params$Resource$Table$Replacerows, options?: MethodOptions): AxiosPromise<Schema$Task>;
    ...
    interface Params$Resource$Table$Refetchsheet {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Table$Replacerows {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

...
export declare namespace firestore_v1 {
    ...
    class Resource$Projects$Databases$Operations {
         ...
         */
        cancel(params?: Params$Resource$Projects$Databases$Operations$Cancel, options?: MethodOptions): AxiosPromise<Schema$Empty>;
         ...
         * @return {object} Request object
         */
        delete(params?: Params$Resource$Projects$Databases$Operations$Delete, options?: MethodOptions): AxiosPromise<Schema$Empty>;
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Projects$Databases$Operations$Get, options?: MethodOptions): AxiosPromise<Schema$GoogleLongrunningOperation>;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Projects$Databases$Operations$List, options?: MethodOptions): AxiosPromise<Schema$GoogleLongrunningListOperationsResponse>;
    ...
    interface Params$Resource$Projects$Databases$Operations$Cancel {
        /**
    ...
    interface Params$Resource$Projects$Databases$Operations$Delete {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Databases$Operations$Get {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Databases$Operations$List {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

...
var words = ["words", "are", "cool", "and", "so", "are", 
"you", "inconstituent", "funhouse!", "apart", "from", 
"Steve", "fish", "wa", "hej"].map(function(word) {
  return {
      word: word,
      freq: Math.floor(Math.random() * 70) + 10
  }
})
...
function createWordObject(word, freq) {
  ...
  wordContainer.style.fontFamily = 'Quicksand';
